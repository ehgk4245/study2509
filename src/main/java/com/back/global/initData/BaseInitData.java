...
public class BaseInitData {
    ...
    public void work1() {
        ...
        Post post1 = postService.create(new PostWriteRequest("제목 1", "내용 1"));
        Post post2 = postService.create(new PostWriteRequest("제목 2", "내용 2"));
        Post post3 = postService.create(new PostWriteRequest("제목 3", "내용 3"));
